	...
	<main>
		<div class="row mt-5 mb-5">
			...
			<div class="col-12 col-sm-12 col-md-4">
				<form:form action="/DangKy" modelAttribute="Newuser" method="post">
					<center>
						<h4>Đăng Ký</h4>
						<p>
						...
						<input class="mb-3 p-2" style="width: 60%;" type="text"
							placeholder="Họ Tên" name="fullname" id=""> <br> 
	  		  ...
	  		  <div class="form-text text-danger" role="alert">
		  		${error_loginUsername}
							...
							placeholder="Email" name="email" id=""> <br> 
							<c:if test="${not empty error_loginUsername}">
	  		  <div class="form-text text-danger" role="alert">
		  		${error_loginUsername}
			  </div>
							...
							<c:if test="${not empty error_dangky}">
	  		  <div class="form-text text-danger" role="alert">
		  		${error_dangky}
			  </div>
	  	    </c:if>
